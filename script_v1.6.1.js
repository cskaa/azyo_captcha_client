class AzyoCaptcha{
  ...
  constructor(id, trigger, holder, onfinish){
    ...
    $.ajax({
      type: "POST",
      enctype: 'JSON',
      url: 'https://platform.azyo.io:5003/secret_code_check',
  ...
  drawUserInstr(current_task){
    ...
    if (current_task == "fingersOnLips"){
      ...
      this.inst.innerHTML = "Please Blink 4 times.<br>Times blinked: "+ this.longBlinkCounter
      this.normal_pic.style.display = "block"
    }
  }
  ...
  increment_succ(id, onfinish){
    $.ajax({
      type: "POST",
      enctype: 'JSON',
      url: "https://platform.azyo.io:5003/success_count",
